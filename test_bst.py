...
class BSTTestCase(unittest.TestCase):
    ...
    def test_add(self):
        ...
        # bs_tree must be empty
        self.assertEqual(bs_tree.size(), 0)
        # Add a key-value pair
        bs_tree.add(15, "Value for 15")
        # Size of bs_tree must be 1
        self.assertEqual(bs_tree.size(), 1)
        # Add another key-value pair
        bs_tree.add(10, "Value for 10")
        # Size of bs_tree must be 2
        self.assertEqual(bs_tree.size(), 2)
        # The added keys must exist.
        self.assertEqual(bs_tree.search(10), "Value for 10")
        self.assertEqual(bs_tree.search(15), "Value for 15")
